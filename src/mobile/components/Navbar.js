...
<div className={`sidebar bg-purple-800 text-blue-100 ${sidebar ? '' : ' -translate-x-full'} w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform md:relative md:translate-x-0 transition duration-200 ease-in-out`}>
...
<div className="bg-purple-600">
   <div className="container mx-auto px-3 pb-2">
      <span className={` ${sidebar ? "hidden" : ""} absolute z-10 py-3 pl-3 w-8  z-10 py-3 pl-3 w-8 bg-transparent rounded text-base font-normal text-gray-400 text-center flex items-center justify-center`}>
